    ...
    <form class="p-3" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="object" id="formGroupExampleInput" value="{{ $book->object }}"
                    required>
            </div>
            <div class="form-group">
                <label for="formGroupExampleInput">期號</label>
                <input type="text" class="form-control" name="issue" id="formGroupExampleInput" value="{{ $book->issue }}"
                    required>
