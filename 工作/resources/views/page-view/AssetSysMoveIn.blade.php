...
@section('content')
    ...
    <form class="p-3" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="object" id="formGroupExampleInput" placeholder="(E-004-01)Micro USB 充電線">
        </div>
        <div class="form-group ">
            <label for="formGroupExampleInput">標籤</label>
            <input type="text" class="form-control" name="lab" id="formGroupExampleInput" placeholder="ex:y">
        </div>
